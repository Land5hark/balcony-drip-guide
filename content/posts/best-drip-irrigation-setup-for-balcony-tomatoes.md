...
**Method**: Add a [fertilizer injector](https://aff.dripdepot.com/aff/idevaffiliate.php?id=546) between the faucet and the pressure regulator. Use a water-soluble tomato fertilizer (e.g., 18-18-21 NPK) every 10–14 days during fruiting.
...
|-----------|---------------------|------------------|
| Drip kit | [Drip Depot Container Kit](https://aff.dripdepot.com/aff/idevaffiliate.php?id=546) (Standard) | $45–55 |
| Extra emitters | 1 GPH pressure-compensating drippers (pack of 10) | $8–12 |
| Timer (if no faucet) | [RainPoint Solar Timer](https://www.rainpointus.com/) | $35–45 |
