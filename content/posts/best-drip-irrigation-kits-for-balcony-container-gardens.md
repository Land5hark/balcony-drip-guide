...
> Method note: Recommendations below are based on fit for balcony and container setups plus published merchant and product details verified on 2026-04-30. This is not long-term bench testing.
>
...
- **No faucet access?** A solar or pump-based reservoir kit is the right category.
...
If your balcony does **not** have faucet access, skip generic hose-timer roundups and look specifically at **solar or reservoir-fed potted-plant kits**.
...
For faucet-fed systems, a filter and pressure control are not fluff. Small emitters clog easily, and balcony leaks are more annoying than garden-bed leaks.

### 4) Expansion
Many people start with a few containers and add more during the season. A kit that can expand is usually a better long-term buy than a rigid all-in-one box.
...
Drip Depot publishes a dedicated container-kit buying guide and says its container irrigation kits are designed to connect to a standard outdoor faucet or garden hose. Its published kit range covers roughly **10 to 120 containers**, and it also offers a **Build Your Own** selector when a standard kit does not fit cleanly.
...
RainPoint’s solar kit is the strongest fit here because it solves the actual apartment-balcony problem: **automatic watering from a reservoir instead of a hose connection**.
...
On the live page reviewed 2026-04-30, RainPoint lists the product as **Auto Drip Irrigation Kit with Cycle & Soak, for 10-15 Potted Plants**. The published details say it can water **10 plants, expandable to 15**, includes **10 emitters** and **1 filter**, and allows watering frequency from **every 8 hours to once every 30 days** with durations from **20 seconds to 20 minutes**.
...
### My take
This looks like a convenience-first kit. That is fine if your collection is small and predictable. If your layout is already varied, a modular system is usually safer.
...
A marketing claim like “up to 20 plants” does not tell you whether those plants are small herbs or large summer vegetables.

### Ignoring the water source
If there is no usable faucet, faucet-based recommendations are noise.

### Underestimating filters and pressure control
Small emitters clog. On balconies, clean and controlled flow matters.
