...
- **bucket-fed drip** usually wins on cost and simplicity
- **solar-pump drip** can win on purpose-built automation when the balcony gets enough sun and the setup justifies the extra hardware
...
- owner affiliate account approval and payout or tax setup
- governed affiliate URL insertion after program approval
- one final spot check on current solar-kit, reservoir-kit, and reservoir-accessory destination paths
